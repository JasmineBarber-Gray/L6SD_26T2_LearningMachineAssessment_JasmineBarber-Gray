...
debt = st.number_input("Credit Card Debt", min_value=0, max_value=500_000, value=10000)
stocks = st.number_input("Stocks", min_value=0.0, max_value=1_000_000.0, value=20000.0)
mutual_funds = st.number_input("Mutual Funds", min_value=0.0, max_value=1_000_000.0, value=15000.0)
...
if st.button("Predict Net Worth"):
    ...
    st.info("Prediction is based on trained ML model (may vary ±100k depending on data noise)")